...
thirdElementOfSecondList xs = maybeTryHead $ maybeTryTail $ maybeTryTail $ maybeTryHead $ tryTail xs
...
fifthElement xs = maybeTryHead $ maybeTryTail $ maybeTryTail $ maybeTryTail $ tryTail xs
                                 where maybeTryHead xs = case xs of
                                                           Just a -> tryHead a
                                                           _      -> Nothing
                                       maybeTryTail xs = case xs of
