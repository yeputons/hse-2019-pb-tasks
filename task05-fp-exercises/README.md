...
1. Команда `ghci -W -Wno-unused-matches Exercises.hs` загружает модуль без warning'ов.
...
### Сроки
Задание выдано 17.01.2020 (пятница).

Срок сдачи — **24.01.2020 (пятница) 22:59 по Москве**.
